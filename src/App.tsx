...
function App() {
  return (
    <div className="App">
      ...
      <Footer />
      <Modal>
        <p className="personal-data__title title">Обработка данных</p>
        <div className="personal-data__paragraph">
          <p className="personal-data__paragraph-title">
          ...
          <p>
            ...
            маркет»), могут получить о Вас в процессе использования Вами любых
